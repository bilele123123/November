  ...
  return (
    <div className="text-center flex align-middle justify-center items-center font-[family-name:var(--font-geist-mono)]">
      <div className="flex-col m-4">
        ...
        <p className="mb-3">Every day, you inspire me with your intelligence and determination. I am so lucky to have someone as thoughtful and caring as you by my side.</p>
        ...
        <p className="mb-12">You balance strength with such grace, and your heart is as beautiful as your mind is sharp. I am so grateful for you.</p>
        <p>
